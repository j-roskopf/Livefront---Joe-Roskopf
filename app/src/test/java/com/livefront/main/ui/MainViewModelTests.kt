...
class MainViewModelTests {
    ...
    @Before
    fun setup() {
        mockedMovieService = Mockito.mock(MovieService::class.java)
        mainViewModel = MainViewModel(mockedMovieService)

        mockSchedulers()
    }

    @Test()
    fun testSuccessfulUpcomingMoviesCall() {
        /**
         * Verifies our live data updates correctly after a successful API call
         */
        val page = 1

        Mockito.`when`(mockedMovieService.getUpcomingMovies(page)).thenReturn(
                Observable.just(getSampleMovieResponseFromJson())
        )

        mainViewModel.fetchMoviesFromCallType(page, CallType.Upcoming)
    ...
    @Test()
    fun testFailedUpcomingMoviesCall() {
        /**
         * Verifies our live data updates correctly with a null value after a successful API call
         */
        val page = 1
    ...
    @Test()
    fun testSuccessfulNowPlayingMoviesCall() {
        /**
         * Verifies our live data updates correctly after a successful API call
         */
        val page = 1

        Mockito.`when`(mockedMovieService.getMoviesCurrentlyInTheatre(page)).thenReturn(
                Observable.just(getSampleMovieResponseFromJson())
        )

        mainViewModel.fetchMoviesFromCallType(page, CallType.Theatre)
    ...
    @Test()
    fun testFailedNowPlayingMoviesCall() {
        /**
         * Verifies our live data updates correctly with a null value after a successful API call
         */
        val page = 1
    ...
    @Test()
    fun testSuccessfulAllTimeMoviesCall() {
        /**
         * Verifies our live data updates correctly after a successful API call
         */
        val page = 1

        Mockito.`when`(mockedMovieService.getAllTimeMostPopularMovies(page)).thenReturn(
                Observable.just(getSampleMovieResponseFromJson())
        )

        mainViewModel.fetchMoviesFromCallType(page, CallType.MostPopularAllTime)
    ...
    @Test()
    fun testFailedAllTimeMoviesCall() {
        /**
         * Verifies our live data updates correctly with a null value after a successful API call
         */
        val page = 1
